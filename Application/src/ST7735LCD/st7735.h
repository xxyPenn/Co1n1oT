...
#define LCD_SPI                 EXT1_SPI_MODULE

#define LCD_SPI_PINMUX_SETTING  EXT1_SPI_SERCOM_MUX_SETTING
#define LCD_SPI_PINMUX_PAD0     EXT1_SPI_SERCOM_PINMUX_PAD0
#define LCD_SPI_PINMUX_PAD1     EXT1_SPI_SERCOM_PINMUX_PAD1
#define LCD_SPI_PINMUX_PAD2     EXT1_SPI_SERCOM_PINMUX_PAD2
#define LCD_SPI_PINMUX_PAD3     EXT1_SPI_SERCOM_PINMUX_PAD3
// Define the SPI clock source
#define LCD_SPI_SOURCE_CLOCK    GCLK_GENERATOR_0
#define LCD_CS                  EXT1_PIN_15
